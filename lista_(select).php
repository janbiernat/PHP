...
Komputery - metoda 1:&nbsp;<SELECT NAME="ComboBox"> 
<?php 
...
<BR /><BR /> 
Komputery - metoda 2:&nbsp;<SELECT NAME="ComboBox"> 
<?php 
...
<?php 
  //Wywołanie funkcji "ListaSelect" - metoda 3. 
    ...
    echo "<BR />Ilość elementów: ".ListaSelect($Dane3, "Atari Portfolio", false, 'NAME="Lista" STYLE="width:150px;"'); 
?> 
<BR /><BR /> 
Komputery - metoda 4: 
<?php 
  //Wywołanie funkcji "ListaSelect" - metoda 4. 
    ...
    echo "<BR />Ilość elementów: ".ListaSelect($Dane4, "Commodore", true, 'NAME="Lista" STYLE="width:150px;"'); 
?> 
</BODY> 
</HTML> 