<?php 
  ...
  //Wywołanie funkcji "ZeroPrzed" i "CzasSpr". 
    ...
    echo "<BR />Czas - nic: ".CzasSpr(""); 
    echo "<BR />Czas [0:0:0]?: ".CzasSpr("0:0:0"); 
    echo "<BR />Czas [0:00:00]?: ".CzasSpr("0:00:00"); 
    echo "<BR />Czas [00:0:00]?: ".CzasSpr("00:0:00"); 
    echo "<BR />Czas [00:00:0]?: ".CzasSpr("00:00:0"); 
    echo "<BR />Czas [00:0:0]?: ".CzasSpr("00:0:0"); 
    echo "<BR />Czas [0:00:0]?: ".CzasSpr("0:00:0"); 
    echo "<BR />Czas [0:0:00]?: ".CzasSpr("0:0:00"); 
